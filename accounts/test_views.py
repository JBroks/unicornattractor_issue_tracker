...
from .forms import UserRegistrationForm, UserLoginForm, UserChangeForm, \
    UploadFileForm, UserDeleteForm
...
class TestRegistrationViews(TestCase):
    ...
    def test_registration_view_initial(self):
        '''
        Test registration view (get response) - if view redirects to
        the correct URL and a correct template is used.
        '''
...
class TestProfileViews(TestCase):
    ...
    def test_get_user_profile_page(self):
        ...
        page = self.client.get("/accounts/{0}/profile/".format(
               self.user.username))
        self.assertEqual(page.status_code, 200)
    ...
    def test_get_user_profile_edit_page(self):
        ...
        page = self.client.get("/accounts/{0}/profile-edit/".format(
               self.user.username))
        self.assertEqual(page.status_code, 200)
