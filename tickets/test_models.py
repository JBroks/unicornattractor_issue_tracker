...
class TestTicket(TestCase):
        ...
        def test_ticket_creation(self):
            ...
            displayed_object_name = f'Ticket #{new_ticket.id}' \
                f' [{new_ticket.ticket_status}] {new_ticket.ticket_type}' \
                f' - {new_ticket.subject}'
...
class TestUpvote(TestCase):
        ...
        def test_upvote_creation(self):
            ...
            displayed_object_name = f'Ticket #{new_upvote.ticket.id}' \
                f' upvoted by {new_upvote.user.username}'
...
class TestDonation(TestCase):
        ...
        def test_donation_creation(self):
            ...
            displayed_object_name = f'€{new_donation.donation_amount}' \
                f' donated by {new_donation.user.username}' \
                f' for ticket #{new_donation.ticket.id}'
...
class TestComment(TestCase):
        ...
        def test_comment_creation(self):
            ...
            displayed_object_name = f'Comment #{new_comment.id} added by ' \
                f'{new_comment.user.username} for ticket ' \
                f'#{new_comment.ticket.id}'
